...
public class OLDSendHeartBeat implements Runnable{
    ...
    public OLDSendHeartBeat(int leftPortNum, int rightPortNum, InetAddress leftIpAddress, InetAddress rightIpAddress)
    {
    ...
    public void run()
    {
        ...
        }catch(Exception e)
        {
            ...
            try {
                OLDMain.log.writeLogLine("Exception sendHB: " + e.getMessage());}
